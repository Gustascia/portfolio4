      ...
      <div className={`  max-w-7xl flex flex-row items-start gap-5 `}>
        <div>
          <h1 className={`${styles.heroHeadText}`}>
            Hi, I'm <span className="text-[#F9C784]">Gustas</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white `}>
            <br className="sm:block hidden" /> A freelance web developer{' '}
            <br></br> at your service
          </p>
        </div>
        <div className="flex justify-center items-center">
          <img
            src={gusto}
            alt="gusto photo"
            className="max-w-[300px] rounded-full aspect-auto m-4 "
          />
        </div>
      </div>
      <style jsx>{`
